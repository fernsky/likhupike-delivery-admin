...
export default function HomePageSEO({
  ...
  const localGovernmentData = {
    ...
    logo: "https://digital.likhupikemun.gov.np/images/municipality-logo.png",
    address: {
      "@type": "PostalAddress",
    ...
    contactPoint: {
      ...
      email: "info@digital.likhupikemun.gov.np",
    },
    sameAs: [
      "https://www.facebook.com/likhupikeruralmun/",
      "https://twitter.com/likhupikerural",
      "https://www.youtube.com/channel/likhupikeruralmun",
    ],
    areaServed: {
  ...
  const demographicDataset = {
    ...
    url: "https://digital.likhupikemun.gov.np/profile/demographics",
    keywords: [
  ...
  const placeData = {
    ...
    hasMap: "https://digital.likhupikemun.gov.np/map",
    geo: {
      "@type": "GeoCoordinates",
      latitude: "28.1356",
      longitude: "81.6314",
  ...
  const websiteData = {
    ...
    potentialAction: {
      "@type": "SearchAction",
      target:
        "https://digital.likhupikemun.gov.np/search?q={search_term_string}",
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "मुख्य पृष्ठ",
        item: "https://digital.likhupikemun.gov.np",
      },
    ],
  };
