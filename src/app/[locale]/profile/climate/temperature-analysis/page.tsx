...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "लिखु पिके गाउँपालिकाको तापक्रम विश्लेषण र जलवायु परिवर्तन प्रभाव",
    keywords: [
      "लिखु पिके गाउँपालिका तापक्रम विश्लेषण",
      "जलवायु परिवर्तन लिखु पिके",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="तापक्रम विश्लेषण - लिखु पिके गाउँपालिका"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकाको तापक्रम विश्लेषण
            </h1>
            <p>
