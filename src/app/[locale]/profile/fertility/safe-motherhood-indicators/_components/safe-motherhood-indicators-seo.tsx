...
export default function SafeMotherhoodIndicatorsSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Safe Motherhood Indicators in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/health/safe-motherhood-indicators",
      creator: {
        "@type": "Organization",
