...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "सुरक्षित मातृत्व सूचकहरू | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        "लिखु पिके गाउँपालिकामा मातृ स्वास्थ्य सेवा र सूचकहरूको अवस्था र विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सुरक्षित मातृत्व सेवा - लिखु पिके गाउँपालिका (Safe Motherhood Services - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा सुरक्षित मातृत्व सेवाको अवस्था
            </h1>
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको वर्ष{" "}
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकाको सुरक्षित मातृत्व सेवाको अवस्थामा
