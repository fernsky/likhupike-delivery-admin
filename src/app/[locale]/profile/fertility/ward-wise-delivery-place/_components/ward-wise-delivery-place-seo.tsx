...
export default function WardWiseDeliveryPlaceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Childbirth Locations in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/fertility/ward-wise-delivery-place",
      creator: {
        "@type": "Organization",
