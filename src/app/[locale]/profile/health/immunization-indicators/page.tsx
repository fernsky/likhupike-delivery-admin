...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title: "खोप सेवा र कभरेज | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        "लिखु पिके गाउँपालिकामा आधारभूत खोप सेवा र कभरेजको अवस्था र विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खोप सेवा र कभरेज - लिखु पिके गाउँपालिका (Immunization Services and Coverage - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा खोप सेवा र कभरेजको अवस्था
            </h1>
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको आर्थिक वर्ष{" "}
            ...
            <p>
              लिखु पिके गाउँपालिकामा आर्थिक वर्ष{" "}
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा खोप सेवाको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकाको खोप सेवाको अवस्थामा सुधार ल्याउन
