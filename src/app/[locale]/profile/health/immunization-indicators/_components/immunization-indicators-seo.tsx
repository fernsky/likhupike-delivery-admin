...
export default function ImmunizationIndicatorsSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Immunization Indicators in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/health/immunization-indicators",
      creator: {
        "@type": "Organization",
