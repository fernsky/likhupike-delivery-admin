...
export default function WardWiseTimeToHealthOrganizationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Time to Health Organization in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/health/ward-wise-time-to-health-organization",
      creator: {
        "@type": "Organization",
