...
export default function WardWiseHealthInsuredHouseholdsSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Health Insurance Coverage in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/health/ward-wise-health-insured-households",
      creator: {
        "@type": "Organization",
