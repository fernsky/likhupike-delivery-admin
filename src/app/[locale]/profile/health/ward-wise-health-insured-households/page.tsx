...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका स्वास्थ्य बीमा",
    ...
    // Create description
    const descriptionNP = `लिखु पिके गाउँपालिकामा स्वास्थ्य बीमा सम्बन्धी विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(insuredPercentage, "ne")}% (${localizeNumber(totalInsuredHouseholds.toLocaleString(), "ne")}) घरधुरीले स्वास्थ्य बीमा गरेका छन्।`;
    ...
    return {
      title:
        "स्वास्थ्य बीमा गरेका घरधुरीको अवस्था | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="स्वास्थ्य बीमा गरेका घरधुरीको अवस्था - लिखु पिके गाउँपालिका (Health Insured Households - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा स्वास्थ्य बीमा गरेका घरधुरीको अवस्था
            </h1>
            ...
            <p>
              ...
              गर्दछ। यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा
              स्वास्थ्य बीमा गरेका घरधुरीको अवस्था र विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              लिखु पिके गाउँपालिकामा कुल{" "}
              ...
              घरधुरी हो। यसले लिखु पिके गाउँपालिकामा स्वास्थ्य बीमाको महत्व र
            ...
            <p>
              लिखु पिके गाउँपालिकामा स्वास्थ्य बीमा गरेका र नगरेका घरधुरीको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा स्वास्थ्य बीमाको अवस्थाको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(insuredPercentage, "ne")}% घरधुरीले स्वास्थ्य बीमा
            ...
            <p>
              लिखु पिके गाउँपालिकामा स्वास्थ्य बीमाको अवस्था विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकामा स्वास्थ्य बीमाको अवस्थाको विश्लेषणले
