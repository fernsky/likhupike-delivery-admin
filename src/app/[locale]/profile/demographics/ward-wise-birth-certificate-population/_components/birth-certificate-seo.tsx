...
export default function BirthCertificateSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      url: "https://likhupike.gov.np/profile/demographics/ward-wise-birth-certificate-population",
      spatialCoverage: {
        "@type": "Place",
      ...
      distribution: [
        {
          ...
          contentUrl:
            "https://likhupike.gov.np/api/profile/demographics/ward-wise-birth-certificate-population",
        },
      ],
