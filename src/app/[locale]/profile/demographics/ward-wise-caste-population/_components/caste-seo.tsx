...
export default function CasteSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Caste Demographics of Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/demographics/ward-wise-caste-population",
      creator: {
        "@type": "Organization",
