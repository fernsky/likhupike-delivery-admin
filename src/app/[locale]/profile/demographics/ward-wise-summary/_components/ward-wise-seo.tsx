...
export default function WardWiseSEO({
  ...
  const generateStructuredData = () => {
    ...
    const wardObservations = processedWardData.map((ward) => ({
      "@type": "Observation",
      name: `लिखु पिके गाउँपालिका वडा ${ward.wardNumber} demographics`,
      ...
      description: `लिखु पिके गाउँपालिका वडा ${localizeNumber(
        ward.wardNumber,
        "ne",
    ...
    return {
      ...
      "@type": "Dataset",
      name: "लिखु पिके गाउँपालिका - वडागत जनसांख्यिकी तथ्याङ्क",
      description: `लिखु पिके गाउँपालिकाको ${localizeNumber(
