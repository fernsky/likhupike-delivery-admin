...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const municipalityName = "लिखु पिके गाउँपालिका"; // Khajura Rural Municipality
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका वडागत जनसंख्या",
      "लिखु पिके गाउँपालिका वडा विवरण",
      "लिखु पिके गाउँपालिका जनसांख्यिकी तथ्याङ्क",
      "लिखु पिके गाउँपालिका घरधुरी विवरण",
      `लिखु पिके गाउँपालिका जनसंख्या ${localizeNumber(totalPopulation, "ne")}`,
      `लिखु पिके गाउँपालिका घरधुरी ${localizeNumber(totalHouseholds, "ne")}`,
      "लिखु पिके गाउँपालिका लैङ्गिक अनुपात",
      "लिखु पिके गाउँपालिका वडागत विश्लेषण",
      `लिखु पिके गाउँपालिका वडा ${localizeNumber(highestWardNumber, "ne")} जनसंख्या ${localizeNumber(highestPopulation, "ne")}`,
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडागत जनसांख्यिकी सारांश। कुल जनसंख्या ${localizeNumber(totalPopulation, "ne")} (पुरुष: ${localizeNumber(malePopulation, "ne")}, महिला: ${localizeNumber(femalePopulation, "ne")}) र कुल घरधुरी ${localizeNumber(totalHouseholds, "ne")} रहेको छ। लिखु पिके गाउँपालिकाका ${localizeNumber(wardCount, "ne")} वडाहरूमध्ये वडा ${localizeNumber(highestWardNumber, "ne")} मा सबैभन्दा बढी जनसंख्या (${localizeNumber(highestPopulation, "ne")}) रहेको छ। लिखु पिके गाउँपालिकाको समग्र लैङ्गिक अनुपात ${localizeNumber(overallSexRatio, "ne")} र औसत परिवार संख्या ${localizeNumber(averageHouseholdSize, "ne")} रहेको छ। सबै वडाहरूको जनसंख्या वितरण, लैङ्गिक अनुपात, घरधुरी र परिवार संख्याको विस्तृत विश्लेषण प्रस्तुत गरिएको छ।`;
    ...
    return {
      title: `लिखु पिके गाउँपालिका | वडागत जनसांख्यिकी सारांश | डिजिटल प्रोफाइल`,
      ...
      openGraph: {
        title: `लिखु पिके गाउँपालिका | वडागत जनसांख्यिकी सारांश`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
    ...
    return {
      title:
        "लिखु पिके गाउँपालिका | वडागत जनसांख्यिकी सारांश | डिजिटल प्रोफाइल",
      description:
        "लिखु पिके गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकी विवरण, लिङ्ग अनुपात, घरधुरी र जनसंख्या वितरणको विश्लेषण।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="लिखु पिके गाउँपालिका | वडागत जनसांख्यिकी सारांश (Khajura Rural Municipality Ward Demographics Summary)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिका | वडागत जनसांख्यिकी सारांश
            </h1>
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकी
            ...
            <p>
              वडागत विश्लेषणले लिखु पिके गाउँपालिकाभित्र रहेका विविधता र
            ...
            >
              लिखु पिके गाउँपालिकाको वडागत जनसंख्या वितरण
            </h2>
            <p>
              लिखु पिके गाउँपालिकाको कुल जनसंख्या{" "}
              {localizeNumber(
              ...
              अन्य लिङ्गका व्यक्तिहरू रहेका छन्। लिखु पिके गाउँपालिकाका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकाको प्रत्येक वडाको जनसांख्यिकीय संरचनाको
