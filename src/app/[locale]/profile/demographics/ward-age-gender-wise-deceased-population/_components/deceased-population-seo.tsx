...
export default function DeceasedPopulationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Age and Gender Wise Deceased Population in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/demographics/ward-age-gender-wise-deceased-population",
      creator: {
        "@type": "Organization",
