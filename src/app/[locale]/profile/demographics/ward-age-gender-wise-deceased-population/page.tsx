...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका मृत्यु विवरण",
      "लिखु पिके मृत्यु दर",
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडा, उमेर र लिङ्ग अनुसार मृत्यु भएका जनसंख्याको वितरण र विश्लेषण। कुल मृत्यु संख्या ${localizeNumber(totalDeceasedPopulation.toString(), "ne")} मध्ये ${localizeNumber(mostAffectedPercentage, "ne")}% (${localizeNumber(mostAffectedCount.toString(), "ne")}) ${AGE_GROUP_NAMES[mostAffectedAgeGroup] || mostAffectedAgeGroup} उमेर समूहमा रहेका छन्। विभिन्न वडाहरूमा उमेर र लिङ्ग अनुसार मृत्युको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "उमेर तथा लिङ्ग अनुसार मृत्यु विवरण | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="उमेर तथा लिङ्ग अनुसार मृत्यु विवरण - लिखु पिके गाउँपालिका (Age and Gender Wise Deceased Population - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा उमेर तथा लिङ्ग अनुसार मृत्यु विवरण
            </h1>
            ...
            <p>
              लिखु पिके गाउँपालिकाको जनसांख्यिकी विश्लेषणमा उमेर र लिङ्ग
              ...
              गर्न मद्दत गर्दछ। यस खण्डमा लिखु पिके गाउँपालिकाको वडा, उमेर र
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा उमेर र लिङ्ग अनुसारको मृत्युदरको विश्लेषण
