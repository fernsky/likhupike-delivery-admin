  ...
  return (
    <>
      ...
      >
        ...
        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            लिखु पिके गाउँपालिकामा धर्म अनुसार जनसंख्या वितरण
          </h3>
      ...
      >
        ...
        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            लिखु पिके गाउँपालिकाको वडा अनुसार धर्म वितरण
          </h3>
          <p className="text-sm text-muted-foreground">
      ...
      >
        ...
        <div className="border-b px-4 py-3">
          <h3 className="text-xl font-semibold" itemProp="headline">
            लिखु पिके गाउँपालिकाको वडा अनुसार विस्तृत धार्मिक विश्लेषण
          </h3>
          <p className="text-sm text-muted-foreground">
