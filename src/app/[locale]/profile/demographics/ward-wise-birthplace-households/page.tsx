...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका घरपरिवारको जन्मस्थान",
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडा अनुसार घरपरिवारको जन्मस्थानको वितरण र विश्लेषण। कुल घरपरिवार संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ${BIRTH_PLACE_NAMES[mostCommonBirthplace] || mostCommonBirthplace} बाट आएका देखिन्छ। विभिन्न वडाहरूमा घरपरिवारको जन्मस्थानको विस्तृत विश्लेषण।`;
    ...
    return {
      title: "घरपरिवारको जन्मस्थान | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरपरिवारको जन्मस्थान - लिखु पिके गाउँपालिका (Household Birthplaces - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा घरपरिवारको जन्मस्थान
            </h1>
            ...
            <p>
              ...
              विश्लेषण गर्न सहयोग गर्दछ। यस खण्डमा लिखु पिके गाउँपालिकामा
              रहेका घरपरिवारको जन्मस्थान अनुसारको वितरण र वडागत विश्लेषण
              प्रस्तुत गरिएको छ।
            </p>
            <p>
              लिखु पिके गाउँपालिकामा रहेका परिवारहरूको जन्मस्थानको तथ्याङ्क
              हेर्दा, कुल घरपरिवार{" "}
            ...
            <p>
              लिखु पिके गाउँपालिकामा रहेका परिवारहरूको जन्मस्थानको विवरण र
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा रहेका परिवारहरूको जन्मस्थानको विश्लेषण
              गर्दा,
