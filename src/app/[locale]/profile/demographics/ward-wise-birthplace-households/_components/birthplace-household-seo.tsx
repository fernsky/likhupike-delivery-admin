...
export default function BirthplaceHouseholdSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Household Birthplaces in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/demographics/ward-wise-birthplace-households",
      creator: {
        "@type": "Organization",
