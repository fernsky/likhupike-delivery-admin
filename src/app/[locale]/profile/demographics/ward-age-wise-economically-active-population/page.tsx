...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "आर्थिक रूपमा सक्रिय जनसंख्या | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              ...
              लिखु पिके गाउँपालिकामा विभिन्न उमेर समूहका आर्थिक रूपमा सक्रिय
              जनसंख्याको वडागत वितरण र विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              लिखु पिके गाउँपालिकामा उमेर समूह अनुसार आर्थिक सक्रिय जनसंख्याको
            ...
            <p>
              लिखु पिके गाउँपालिकामा उमेर समूह अनुसार जनसंख्याको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्या (१५-५९ वर्ष)
              समग्र जनसंख्याको
              {localizeNumber(
                (
                  ((overallSummary.find(
