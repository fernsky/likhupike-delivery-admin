...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका उमेर जनसंख्या",
      "लिखु पिके उमेरगत विविधता",
      `लिखु पिके बाल जनसंख्या ${localizeNumber(childrenPct, "ne")}%`,
      `लिखु पिके युवा जनसंख्या ${localizeNumber(youthPct, "ne")}%`,
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडा अनुसार उमेर समूहको जनसंख्या वितरण, प्रवृत्ति र विश्लेषण। कुल जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")} मध्ये बाल जनसंख्या ${localizeNumber(childrenPct, "ne")}%, युवा जनसंख्या ${localizeNumber(youthPct, "ne")}% रहेको छ। उमेर समूह अनुसार विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;
    ...
    return {
      title: `उमेर अनुसार जनसंख्या | लिखु पिके गाउँपालिका | डिजिटल प्रोफाइल`,
      ...
      openGraph: {
        title: `उमेर अनुसार जनसंख्या | लिखु पिके गाउँपालिका`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा उमेर अनुसार जनसंख्या
            </h1>
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा उमेर समूह
            ...
            <p>
              यो तथ्याङ्कले लिखु पिके गाउँपालिकाको जनसांख्यिकीय लाभांश,
            ...
            <p>
              लिखु पिके गाउँपालिकामा विभिन्न उमेर समूहका व्यक्तिहरूको वितरण
              निम्नानुसार छ:
            </p>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकाको जनसंख्याको उमेर संरचनाले निम्न
