...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका मातृभाषा जनसंख्या",
    ...
    return {
      title:
        "लिखु पिके गाउँपालिकामा मातृभाषा अनुसार जनसंख्या | पालिका प्रोफाइल",
    ...
    return {
      title:
        "लिखु पिके गाउँपालिकामा मातृभाषा अनुसार जनसंख्या | पालिका प्रोफाइल",
      description:
        "लिखु पिके गाउँपालिकामा वडा अनुसार मातृभाषा जनसंख्या वितरण, प्रवृत्ति र विश्लेषण। विभिन्न भाषाभाषीहरूको विस्तृत तथ्याङ्क र विजुअलाइजेसन।",
    };
  }
}
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="भाषिक विविधता - लिखु पिके गाउँपालिका (Linguistic Diversity - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा बोलिने
            ...
            <p>
              लिखु पिके गाउँपालिका विभिन्न भाषाभाषी समुदायहरूको सद्भाव र
            ...
            <p>
              लिखु पिके गाउँपालिकामा विभिन्न मातृभाषी वक्ताहरूको कुल जनसंख्या
              निम्नानुसार छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा निम्न भाषाहरू प्रमुख रूपमा बोलिन्छन्। यी
              भाषाहरूमध्ये{" "}
