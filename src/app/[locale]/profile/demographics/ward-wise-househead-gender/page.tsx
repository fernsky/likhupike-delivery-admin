...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका घरमूली लिङ्ग वितरण",
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडा अनुसार घरमूली लिङ्ग वितरण, प्रवृत्ति र विश्लेषण। कुल जनसंख्या ${localizeNumber(totalPopulation.toString(), "ne")} मध्ये पुरुष घरमूली ${localizeNumber(genderCounts["MALE"]?.toString() || "0", "ne")} र महिला घरमूली ${localizeNumber(genderCounts["FEMALE"]?.toString() || "0", "ne")} रहेका छन्। विस्तृत तथ्याङ्क र विजुअलाइजेसन।`;

    return {
      title: `लिखु पिके गाउँपालिका | वडागत घरमूली लिङ्ग वितरण | डिजिटल प्रोफाइल`,
      ...
      openGraph: {
        title: `लिखु पिके गाउँपालिका | वडागत घरमूली लिङ्ग वितरण`,
        description: descriptionNP,
        type: "article",
        locale: "ne_NP",
    ...
    return {
      title:
        "लिखु पिके गाउँपालिका | वडागत घरमूली लिङ्ग वितरण | डिजिटल प्रोफाइल",
      description:
        "लिखु पिके गाउँपालिकाको वडागत घरमूली लिङ्ग वितरण, प्रवृत्ति र विश्लेषण।",
    };
  }
}
        ...
        <section>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              <span className="font-bold">लिखु पिके गाउँपालिकामा</span> वडागत
              घरमूली लिङ्ग वितरण
            </h1>
            ...
            <p>
              यस खण्डमा <strong>लिखु पिके गाउँपालिका</strong>को विभिन्न
            ...
            <p>
              ...
              <strong>लिखु पिके गाउँपालिका</strong>लाई लैङ्गिक समानता सम्बन्धी
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            <h2 id="ward-analysis" className="scroll-m-20 border-b pb-2">
              <strong>लिखु पिके गाउँपालिका</strong>को वडागत विश्लेषण
            </h2>
            <p>
              <strong>लिखु पिके गाउँपालिका</strong>को वडा अनुसार घरमूली लिङ्ग
