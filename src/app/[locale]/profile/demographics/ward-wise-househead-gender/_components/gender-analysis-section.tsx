    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          <strong>लिखु पिके गाउँपालिका</strong>को घरमूली लिङ्ग विश्लेषण
          <span className="sr-only">
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        <h3 className="text-xl font-medium mb-2">
          <strong>लिखु पिके गाउँपालिका</strong>को वडागत घरमूली लिङ्ग विविधता
          <span className="sr-only">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <p>
            <strong>लिखु पिके गाउँपालिका</strong>को वडागत घरमूली लिङ्ग
          ...
          <ul itemScope itemType="https://schema.org/ItemList">
            ...
            >
              ...
              <div itemProp="item">
                ...
                <strong>लिखु पिके गाउँपालिका</strong>
                मा कुल घरमूलीको{" "}
                {localizeNumber(
            ...
            >
              ...
              <div itemProp="item">
                ...
                <strong>लिखु पिके गाउँपालिका</strong>का विभिन्न वडाहरूमा महिला
                घरमूलीको प्रतिशत{" "}
                {localizeNumber(
                  lowestFemaleWard.femalePercentage.toFixed(2),
                  "ne",
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-6">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <p>
            <strong>लिखु पिके गाउँपालिका</strong>को घरमूली लिङ्ग विश्लेषणका
          ...
          <ul>
            <li>
              ...
              <strong>लिखु पिके गाउँपालिका</strong>मा महिला घरमूली प्रतिशत
              बढाउन विशेष आर्थिक सशक्तिकरण र नेतृत्व विकास कार्यक्रमहरू संचालन
              गर्ने।
            </li>
            <li>
              <strong>लैङ्गिक बजेट:</strong>{" "}
              <strong>लिखु पिके गाउँपालिका</strong>को न्यून महिला घरमूली
            ...
            <li>
              ...
              <strong>लिखु पिके गाउँपालिका</strong>मा महिला नेतृत्वका
