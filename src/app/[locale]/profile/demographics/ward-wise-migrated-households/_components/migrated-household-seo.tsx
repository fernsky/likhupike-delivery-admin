...
export default function MigratedHouseholdSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Migrated Households in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/demographics/ward-wise-migrated-households",
      creator: {
        "@type": "Organization",
