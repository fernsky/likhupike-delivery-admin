            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {overallSummary.find(
                  ...
                  ? `लिखु पिके गाउँपालिकामा ${localizeNumber((((overallSummary.find((item) => item.migratedFrom === "ANOTHER_DISTRICT")?.households || 0) / totalHouseholds) * 100).toFixed(2), "ne")}% आप्रवासित घरपरिवारहरू अन्य जिल्लाबाट आएका छन्।`
