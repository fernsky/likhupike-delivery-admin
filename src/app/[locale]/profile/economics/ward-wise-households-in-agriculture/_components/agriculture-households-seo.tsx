...
export default function AgricultureHouseholdsSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Agricultural Households Distribution in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-wise-households-in-agriculture",
      creator: {
        "@type": "Organization",
