...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका घरको बाहिरी गारो",
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको वडा अनुसार घरको बाहिरी गारोको वितरण र विश्लेषण। कुल घरधुरी संख्या ${localizeNumber(totalHouseholds.toString(), "ne")} मध्ये ${localizeNumber(mostCommonPercentage, "ne")}% (${localizeNumber(mostCommonCount.toString(), "ne")}) ${WALL_TYPE_NAMES[mostCommonType] || mostCommonType} प्रकारको बाहिरी गारो भएका घरहरू रहेका छन्। विभिन्न वडाहरूमा घरको बाहिरी गारोको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "घरको बाहिरी गारोको वितरण | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरको बाहिरी गारोको वितरण - लिखु पिके गाउँपालिका (House Outer Wall Distribution - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा घरको बाहिरी गारोको वितरण
            </h1>
            ...
            <p>
              ...
              खण्डमा लिखु पिके गाउँपालिकामा घरको बाहिरी गारोका प्रमुख
              प्रकारहरू र तिनको वडागत वितरणको विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              लिखु पिके गाउँपालिकाको घरको बाहिरी गारोको तथ्याङ्क अनुसार, कुल
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरको बाहिरी गारोका प्रमुख प्रकारहरू र
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरको बाहिरी गारोको वितरण विश्लेषणबाट
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरको बाहिरी गारोको समग्र अवस्था मध्यम
