...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका मसलाबाली",
      "लिखु पिके मसलाको उत्पादन",
      "पालिका स्तरीय मसलाबाली तथ्याङ्क",
      "लसुन उत्पादन लिखु पिके",
      "खुर्सानी उत्पादन तथ्याङ्क",
      "धनिया उत्पादन",
      `लिखु पिके मसलाबाली बिक्री ${localizeNumber(totalSales.toFixed(2), "ne")} टन`,
      `लिखु पिके मसलाबाली आय ${localizeNumber(
    ...
    const descriptionNP = `लिखु पिके गाउँपालिकाको मसलाबाली उत्पादन र बिक्री विश्लेषण। कुल ${localizeNumber(totalProduction.toFixed(2), "ne")} मेट्रिक टन मसलाबाली उत्पादन मध्ये ${localizeNumber(mostProducedPercentage, "ne")}% (${localizeNumber(mostProducedAmount.toFixed(2), "ne")} टन) ${SPICE_TYPES[mostProducedSpice] || mostProducedSpice} रहेको छ। पालिका स्तरीय मसलाबालीको विस्तृत विश्लेषण।`;
    ...
    return {
      title:
        "मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री - लिखु पिके गाउँपालिका (Spices by Production and Sales - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा मसलाबालीको प्रकार अनुसार उत्पादन र बिक्री
            </h1>
            ...
            <p>
              मसलाबाली लिखु पिके गाउँपालिकाको प्रमुख कृषि उत्पादनहरू मध्ये एक
            ...
            <p>
              लिखु पिके गाउँपालिकाको मसलाबाली सम्बन्धी तथ्याङ्क अनुसार, यस
            ...
            <p>
              लिखु पिके गाउँपालिकामा उत्पादित प्रमुख मसलाबालीहरू र तिनको
            ...
            <p>
              मसलाबालीको विश्लेषण गर्दा, लिखु पिके गाउँपालिकामा उत्पादित कुल
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा मसलाबालीको उत्पादनले स्थानीय अर्थतन्त्रमा
            ...
            <p>
              लिखु पिके गाउँपालिकाको प्रमुख मसलाबालीको उत्पादकत्व र बजारीकरणको
            ...
            <p>
              लिखु पिके गाउँपालिकाको मसलाबालीको अवस्थाको विश्लेषणबाट निम्न
            ...
            <p className="mt-6">
              लिखु पिके गाउँपालिकामा मसलाबालीको वर्तमान अवस्थाले अझै विकासको
