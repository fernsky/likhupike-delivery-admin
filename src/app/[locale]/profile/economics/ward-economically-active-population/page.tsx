...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका आर्थिक रूपमा सक्रिय जनसंख्या",
      "लिखु पिके वडागत आर्थिक जनसंख्या",
      "जनसांख्यिकी वर्गीकरण लिखु पिके",
      "कार्यसक्षम उमेर समूह",
      "लिङ्ग अनुसार आर्थिक जनसंख्या",
      "आर्थिक सक्रियता विश्लेषण",
      "१५-५९ वर्ष उमेर जनसंख्या",
      `लिखु पिके कुल आर्थिक जनसंख्या ${totalPopulation}`,
    ];
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="आर्थिक रूपमा सक्रिय जनसंख्या - लिखु पिके गाउँपालिका (Economically Active Population - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्या
            </h1>
            ...
            <p>
              यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा आर्थिक रूपमा
            ...
            <p>
              लिखु पिके गाउँपालिकामा उमेर समूह अनुसार आर्थिक रूपमा सक्रिय
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा आर्थिक रूपमा सक्रिय जनसंख्याको अवस्था
            ...
            <p>
              ...
              लिखु पिके गाउँपालिकाको आफ्नै सर्वेक्षणबाट संकलन गरिएको हो। यी
