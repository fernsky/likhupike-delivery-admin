...
export default function EconomicallyActiveSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Economically Active Population of Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-economically-active-population",
      creator: {
        "@type": "Organization",
      ...
      distribution: {
        ...
        encodingFormat: "CSV",
        contentUrl:
          "https://digital.likhupikemun.gov.np/data/economically-active-population.csv",
      },
    };
  };
