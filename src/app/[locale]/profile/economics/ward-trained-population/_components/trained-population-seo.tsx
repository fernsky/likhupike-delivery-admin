...
export default function TrainedPopulationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Trained Population Distribution of Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://likhupike-rm.gov.np/profile/economics/ward-trained-population",
      creator: {
        "@type": "Organization",
