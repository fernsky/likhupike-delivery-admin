...
export default function IrrigatedAreaSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Ward-wise Irrigated Area in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-wise-irrigated-area",
      creator: {
        "@type": "Organization",
