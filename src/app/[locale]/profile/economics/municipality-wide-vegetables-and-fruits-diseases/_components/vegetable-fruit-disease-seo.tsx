...
export default function VegetableFruitDiseaseSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Vegetable and Fruit Diseases and Pests in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/municipality-wide-vegetables-and-fruits-diseases",
      creator: {
        "@type": "Organization",
