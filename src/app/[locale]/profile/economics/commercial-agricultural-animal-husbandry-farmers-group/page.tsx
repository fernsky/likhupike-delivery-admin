...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका कृषि समूह",
    ...
    return {
      title:
        "व्यावसायिक कृषि तथा पशुपालन समूहहरू | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="व्यावसायिक कृषि तथा पशुपालन समूहहरू - लिखु पिके गाउँपालिका (Commercial Agricultural and Animal Husbandry Farmers Groups - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा व्यावसायिक कृषि तथा पशुपालन समूहहरू
            </h1>
            ...
            <p>
              व्यावसायिक कृषि तथा पशुपालन समूहहरू लिखु पिके गाउँपालिकाको
            ...
            <p>
              लिखु पिके गाउँपालिकामा विभिन्न प्रकारका व्यावसायिक कृषि तथा
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकाका विभिन्न वडाहरूमा व्यावसायिक कृषि तथा
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा व्यावसायिक कृषि तथा पशुपालन समूहहरूको
