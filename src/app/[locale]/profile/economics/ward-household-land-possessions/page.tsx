...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका भूमि स्वामित्व",
      "लिखु पिके जग्गाधनी परिवार",
      "लिखु पिके आर्थिक स्थिति",
      `लिखु पिके वडा ${wardsWithHighestLandPossession[0]?.wardNumber || ""} भूमि स्वामित्व`,
      "वडा अनुसार भूमि स्वामित्व",
      "गाउँपालिका जग्गा तथ्याङ्क",
      "आर्थिक सर्वेक्षण लिखु पिके",
      `लिखु पिके कुल जग्गाधनी परिवार संख्या ${totalHouseholdsWithLand}`,
    ];
            ...
            <section>
              <div className="relative rounded-lg overflow-hidden mb-8">
                <Image
                  ...
                  width={1200}
                  height={400}
                  alt="घरपरिवारको जग्गा स्वामित्व - लिखु पिके गाउँपालिका (Household Land Ownership - Khajura Rural Municipality)"
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl">
                <h1 className="scroll-m-20 tracking-tight mb-6">
                  लिखु पिके गाउँपालिकामा घरपरिवारको जग्गा स्वामित्व
                </h1>
                ...
                <p>
                  यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा जग्गाधनी
                ...
                <p>
                  लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा जग्गाधनी
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl mt-8">
                ...
                <p>
                  लिखु पिके गाउँपालिकामा जग्गा स्वामित्वको वितरण विश्लेषण
                  गर्दा, वडा{" "}
                ...
                <p>
                  माथि प्रस्तुत गरिएका तथ्याङ्कहरू लिखु पिके गाउँपालिकाको
