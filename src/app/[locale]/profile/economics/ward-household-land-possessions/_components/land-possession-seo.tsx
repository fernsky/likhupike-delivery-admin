...
export default function LandPossessionSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Household Land Ownership in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://likhupike-rm.gov.np/profile/economics/ward-household-land-possessions",
      creator: {
        "@type": "Organization",
