...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका वार्षिक आय",
            ...
            <section>
              <div className="relative rounded-lg overflow-hidden mb-8">
                <Image
                  ...
                  width={1200}
                  height={400}
                  alt="वार्षिक आयको पर्याप्तता - लिखु पिके गाउँपालिका (Yearly Income Sustenance - Khajura Rural Municipality)"
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl">
                <h1 className="scroll-m-20 tracking-tight mb-6">
                  लिखु पिके गाउँपालिकामा वार्षिक आयको पर्याप्तता
                </h1>
                ...
                <p>
                  लिखु पिके गाउँपालिकामा वार्षिक आयको पर्याप्तता अनुसार
              ...
              <div className="prose prose-slate dark:prose-invert max-w-4xl mt-8">
                ...
                <p>
                  लिखु पिके गाउँपालिकाका घरपरिवारहरूको वार्षिक आयको पर्याप्तता
                  ...
                  %) मात्र रहेको देखिन्छ। यसले लिखु पिकेमा खाद्य सुरक्षा,
