...
export default function YearlyIncomeSustenanceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Yearly Income Sustenance in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://likhupike-rm.gov.np/profile/economics/ward-yearly-income-sustenance",
      creator: {
        "@type": "Organization",
