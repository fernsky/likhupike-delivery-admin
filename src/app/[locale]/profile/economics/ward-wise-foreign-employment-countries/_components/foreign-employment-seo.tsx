...
export default function ForeignEmploymentSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Foreign Employment Destinations from Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-wise-foreign-employment-countries",
      creator: {
        "@type": "Organization",
