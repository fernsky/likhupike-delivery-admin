...
export default function RemittanceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Ward-wise Remittance Distribution from Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-wise-remittance",
      creator: {
        "@type": "Organization",
