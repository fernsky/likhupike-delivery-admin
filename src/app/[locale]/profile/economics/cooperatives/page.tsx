...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका सहकारी",
      "लिखु पिके सहकारी संस्था",
      "पालिका स्तरीय सहकारी",
      "लिखु पिके बचत तथा ऋण सहकारी",
      `लिखु पिके ${COOPERATIVE_TYPES[mostCommonCooperativeType] || "सहकारी संस्था"}`,
      `वडा ${localizeNumber(wardWithMostCooperatives.toString(), "ne")} सहकारी`,
      `लिखु पिके ${localizeNumber(totalCooperatives.toString(), "ne")} सहकारी संस्था`,
      "महिला सहकारी संस्था",
    ];
    ...
    return {
      title: "सहकारी संस्थाहरू | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सहकारी संस्थाहरू - लिखु पिके गाउँपालिका (Cooperative Institutions - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा सहकारी संस्थाहरू
            </h1>
            ...
            <p>
              सहकारी संस्थाहरू लिखु पिके गाउँपालिकाको आर्थिक विकासमा
            ...
            <p>
              लिखु पिके गाउँपालिकामा विभिन्न प्रकारका सहकारी संस्थाहरू
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकाका विभिन्न वडाहरूमा सहकारी संस्थाहरूको वितरण
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा सहकारी संस्थाहरूको अवस्थाको विश्लेषणबाट
            ...
            <p className="mt-6">
              लिखु पिके गाउँपालिकामा सहकारी संस्थाहरूको प्रभावकारी परिचालनले
