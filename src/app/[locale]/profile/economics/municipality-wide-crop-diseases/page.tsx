...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका बाली रोग कीट",
    ...
    // Create description
    const descriptionNP = `लिखु पिके गाउँपालिकाको बाली रोग र कीटको विश्लेषण। ${localizeNumber(totalCrops.toString(), "ne")} प्रकारका बालीमा देखिने प्रमुख रोग र कीटहरूको विस्तृत अध्ययन। सबैभन्दा प्रभावित बाली ${CROP_TYPES[mostAffectedCrop] || mostAffectedCrop} रहेको छ। पालिका स्तरीय बाली संरक्षण योजना र रणनीतिको विश्लेषण।`;
    ...
    return {
      title: "बाली रोग र कीटपतंग | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="बाली रोग र कीटपतंग - लिखु पिके गाउँपालिका (Crop Diseases and Pests - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा बाली रोग र कीटपतंग
            </h1>
            ...
            <p>
              बाली रोग र कीटपतंग लिखु पिके गाउँपालिकाको कृषि उत्पादनमा मुख्य
            ...
            <p>
              लिखु पिके गाउँपालिकाको बाली रोग र कीट सम्बन्धी तथ्याङ्क अनुसार,
            ...
            <p>
              लिखु पिके गाउँपालिकामा देखिने प्रमुख बाली रोगहरू निम्नानुसार
              रहेका छन्:
            </p>
            ...
            <p>
              लिखु पिके गाउँपालिकामा देखिने प्रमुख कीटपतंगहरू निम्नानुसार
              रहेका छन्:
            </p>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा बाली रोग र कीटपतंगको प्रभावकारी
            ...
            <p>
              लिखु पिके गाउँपालिकाको बाली रोग र कीटपतंगको अवस्थाको विश्लेषणबाट
