...
export default function CropDiseaseSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Crop Diseases and Pests in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/municipality-wide-crop-diseases",
      creator: {
        "@type": "Organization",
