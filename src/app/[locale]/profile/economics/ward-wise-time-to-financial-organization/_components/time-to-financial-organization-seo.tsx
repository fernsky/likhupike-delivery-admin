...
export default function TimeToFinancialOrganizationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Financial Organization Access Time in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/economics/ward-wise-time-to-financial-organization",
      creator: {
        "@type": "Organization",
