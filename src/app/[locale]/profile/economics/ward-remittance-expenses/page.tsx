...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका रेमिट्यान्स खर्च",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="रेमिट्यान्स खर्च - लिखु पिके गाउँपालिका (Remittance Expenses - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा रेमिट्यान्स खर्च
            </h1>
            ...
            <p>
              लिखु पिके गाउँपालिकामा विप्रेषण रकम प्राप्त गर्ने घरपरिवारहरूले
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा विप्रेषण रकमको खर्च निम्न क्षेत्रहरूमा
