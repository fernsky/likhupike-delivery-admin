...
export default function SkillsSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Skills Distribution of Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://likhupike-rm.gov.np/profile/economics/ward-main-skills",
      creator: {
        "@type": "Organization",
        name: "Khajura Rural Municipality",
        alternateName: "लिखु पिके गाउँपालिका",
