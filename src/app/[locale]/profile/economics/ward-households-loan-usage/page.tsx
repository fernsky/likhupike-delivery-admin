...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका कर्जा उपयोग",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कर्जाको उपयोग प्रयोजन - लिखु पिके गाउँपालिका (Loan Usage Purposes - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा कर्जाको उपयोग प्रयोजन
            </h1>
            ...
            <p>
              लिखु पिके गाउँपालिकामा कुल {totalHouseholds.toLocaleString()}{" "}
            ...
            <p>
              लिखु पिके गाउँपालिकामा विभिन्न प्रयोजनका लागि कर्जा लिएका
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरपरिवारहरूले विभिन्न प्रयोजनका लागि
            ...
            <p>
              माथि प्रस्तुत गरिएका तथ्याङ्कहरू लिखु पिके गाउँपालिकाको घरधुरी
