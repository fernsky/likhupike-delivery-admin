...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका घरायसी कामकाज",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी कामकाज - लिखु पिके गाउँपालिका (Household Chores - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा घरायसी कामकाजमा खर्चिने समय
            </h1>
            ...
            <p>
              घरायसी कामकाजमा खर्चिने समय अनुसार लिखु पिके गाउँपालिकाको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरायसी कामकाजमा खर्चिने समयको विश्लेषण
