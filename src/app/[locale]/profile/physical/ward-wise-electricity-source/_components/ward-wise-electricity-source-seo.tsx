...
export default function WardWiseElectricitySourceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Electricity Source Usage in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/physical/ward-wise-electricity-source",
      creator: {
        "@type": "Organization",
