...
export default function WardWiseFacilitiesSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Household Facilities Usage in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/physical/ward-wise-facilities",
      creator: {
        "@type": "Organization",
