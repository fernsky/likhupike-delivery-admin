...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका घरायसी सुविधा",
    ...
    // Create description
    const descriptionNP = `लिखु पिके गाउँपालिकामा घरायसी सुविधाको प्रयोगको विश्लेषण। ${localizeNumber(mobilePercentage, "ne")}% घरहरूमा मोबाइल फोन, ${localizeNumber(televisionPercentage, "ne")}% घरहरूमा टेलिभिजन र ${localizeNumber(internetPercentage, "ne")}% घरहरूमा इन्टरनेट सुविधा रहेको छ।`;
    ...
    return {
      title:
        "घरायसी सुविधाको प्रयोगको अवस्था | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="घरायसी सुविधाको प्रयोगको अवस्था - लिखु पिके गाउँपालिका (Household Facilities Usage - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा घरायसी सुविधाको प्रयोगको अवस्था
            </h1>
            ...
            <p>
              ...
              पार्दछ। यस खण्डमा लिखु पिके गाउँपालिकाको विभिन्न वडाहरूमा प्रयोग
              हुने घरायसी सुविधाहरूको विस्तृत विश्लेषण प्रस्तुत गरिएको छ।
            </p>
            <p>
              लिखु पिके गाउँपालिकामा अनुमानित कुल{" "}
              {localizeNumber(
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको वितरण
              निम्नानुसार रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको विश्लेषण
            ...
            <p>
              लिखु पिके गाउँपालिकामा घरायसी सुविधाको प्रयोगको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकामा घरायसी सुविधाहरूको प्रयोगको
