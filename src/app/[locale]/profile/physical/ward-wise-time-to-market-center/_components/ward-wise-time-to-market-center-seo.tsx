...
export default function WardWiseTimeToMarketCenterSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Time to Market Center in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/physical/ward-wise-time-to-market-center",
      creator: {
        "@type": "Organization",
