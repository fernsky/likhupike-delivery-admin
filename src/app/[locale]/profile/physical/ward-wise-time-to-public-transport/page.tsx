...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका सार्वजनिक यातायात पहुँच",
    ...
    return {
      title:
        "सार्वजनिक यातायात पुग्न लाग्ने समयको अवस्था | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
      description:
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="सार्वजनिक यातायात पुग्न लाग्ने समय - लिखु पिके गाउँपालिका (Time to Public Transport - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
              अवस्था
            </h1>
            ...
            <p>
              ...
              अवस्था बुझ्न मद्दत पुर्‍याउँछ। यस खण्डमा लिखु पिके गाउँपालिकाको
            ...
            <p>
              लिखु पिके गाउँपालिकामा सार्वजनिक यातायातसम्म पुग्न लाग्ने समयको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा सार्वजनिक यातायात पहुँचको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                timeCategoryPercentages.UNDER_30_MIN.toFixed(2),
                "ne",
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकामा सार्वजनिक यातायात पुग्न लाग्ने समयको
