...
export default function WardWiseTimeToPublicTransportSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Time to Public Transport in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/physical/ward-wise-time-to-public-transport",
      creator: {
        "@type": "Organization",
