...
export default function WardWiseEducationalLevelSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Educational Level Distribution in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/education/ward-wise-educational-level",
      creator: {
        "@type": "Organization",
