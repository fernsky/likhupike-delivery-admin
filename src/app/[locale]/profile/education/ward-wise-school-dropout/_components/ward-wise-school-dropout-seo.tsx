...
export default function WardWiseSchoolDropoutSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "School Dropout Causes in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/education/ward-wise-school-dropout",
      creator: {
        "@type": "Organization",
