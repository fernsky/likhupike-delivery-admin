...
export default function WardWiseLiteracyStatusSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Literacy Status Distribution in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/education/ward-wise-literacy-status",
      creator: {
        "@type": "Organization",
