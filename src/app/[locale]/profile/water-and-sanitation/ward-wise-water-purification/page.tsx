...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका पानी शुद्धिकरण",
    ...
    return {
      title: "पानी शुद्धिकरण विधिहरू | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="पानी शुद्धिकरण विधिहरू - लिखु पिके गाउँपालिका (Water Purification Methods - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा पानी शुद्धिकरणको अवस्था
            </h1>
            ...
            <p>
              ...
              यस खण्डमा लिखु पिके गाउँपालिकाका विभिन्न वडाहरूमा प्रयोग गरिने
            ...
            <p>
              लिखु पिके गाउँपालिकामा पानी शुद्धिकरणका प्रमुख विधिहरू र तिनको
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा पानी शुद्धिकरण विधिहरूको विश्लेषण गर्दा,
            ...
            <p>
              लिखु पिके गाउँपालिकामा पानी शुद्धिकरण अभ्यासहरू सुधार गर्न निम्न
            ...
            <p className="mt-6">
              यी सिफारिसहरू कार्यान्वयन गरेर, लिखु पिके गाउँपालिकामा पानी
