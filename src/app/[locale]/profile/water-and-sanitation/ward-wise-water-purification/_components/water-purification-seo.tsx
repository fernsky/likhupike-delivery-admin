...
export default function WaterPurificationSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Water Purification Methods in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/water-and-sanitation/ward-wise-water-purification",
      creator: {
        "@type": "Organization",
