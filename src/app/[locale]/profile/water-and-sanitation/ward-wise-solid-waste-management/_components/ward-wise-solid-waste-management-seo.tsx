...
export default function WardWiseSolidWasteManagementSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Solid Waste Management in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/water-and-sanitation/ward-wise-solid-waste-management",
      creator: {
        "@type": "Organization",
