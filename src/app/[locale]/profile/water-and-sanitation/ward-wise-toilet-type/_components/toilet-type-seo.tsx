...
export default function ToiletTypeSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Toilet Types in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/water-and-sanitation/ward-wise-toilet-type",
      creator: {
        "@type": "Organization",
