...
export default function WardWiseDrinkingWaterSourceSEO({
  ...
  const generateStructuredData = () => {
    ...
    return {
      ...
      "@type": "Dataset",
      name: "Drinking Water Sources in Khajura Rural Municipality (लिखु पिके गाउँपालिका)",
      ...
      url: "https://digital.likhupikemun.gov.np/profile/water-and-sanitation/ward-wise-drinking-water-source",
      creator: {
        "@type": "Organization",
