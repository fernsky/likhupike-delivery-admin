...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const keywordsNP = [
      "लिखु पिके गाउँपालिका खानेपानी स्रोत",
    ...
    // Create description
    const descriptionNP = `लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको वडागत विश्लेषण। कुल ${localizeNumber(totalHouseholds.toLocaleString(), "ne")} घरधुरी मध्ये ${localizeNumber(pipedWaterPercentage, "ne")}% (${localizeNumber(pipedWaterHouseholds.toLocaleString(), "ne")}) घरधुरीले पाइपको पानी प्रयोग गर्दछन्।`;
    ...
    return {
      title: "खानेपानीका स्रोतहरू | लिखु पिके गाउँपालिका डिजिटल प्रोफाइल",
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="खानेपानीका स्रोतहरू - लिखु पिके गाउँपालिका (Drinking Water Sources - Khajura Rural Municipality)"
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <h1 className="scroll-m-20 tracking-tight mb-6">
              लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको अवस्था
            </h1>
            ...
            <p>
              ...
              जीवनस्तरको एक महत्वपूर्ण निर्धारक हो। यस खण्डमा लिखु पिके
            ...
            <p>
              लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको वितरण निम्नानुसार
              रहेको छ:
            </p>
          </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none mt-8">
            ...
            <p>
              लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको विश्लेषण गर्दा,
              समग्रमा
              {localizeNumber(
                waterSourceGroupPercentages.PIPED_WATER.toFixed(2),
                "ne",
            ...
            <p>
              लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको तथ्याङ्क
            ...
            <p className="mt-6">
              यसरी लिखु पिके गाउँपालिकामा खानेपानीका स्रोतहरूको विश्लेषणले
