...
export const business = pgTable("acme_likhupike_business", {
...
export const stagingBusiness = pgTable("staging_acme_likhupike_businesses", {
  // Primary identification
  id: text("id").primaryKey().notNull(),
  wardNo: integer("ward_no").notNull(),
  tenantId: text("tenant_id"),
...
export const businessEditRequests = pgTable("acme_likhupike_business_edit_requests", {
