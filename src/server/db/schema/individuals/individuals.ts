...
export const individuals = pgTable("acme_likhupike_individuals", {
...
export const stagingIndividuals = pgTable("staging_acme_likhupike_individuals", {
...
export const individualEditRequests = pgTable("acme_likhupike_individual_edit_requests", {
