...
DO $$
BEGIN
    IF (SELECT COUNT(*) FROM acme_likhupike_household) = 0 THEN
        -- Insert dummy households data
        INSERT INTO acme_likhupike_household (
        ...
        -- Ward 1
        ('household_001', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 1, 
        ...
        ('household_002', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 1, 
        ...
        ('household_003', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 1, 
        ...
        -- Ward 2
        ('household_004', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 2, 
        ...
        ('household_005', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 2, 
        ...
        -- Ward 3
        ('household_006', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 3, 
        ...
        ('household_007', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 3, 
        ...
        -- Ward 4
        ('household_008', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 4, 
        ...
        ('household_009', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 4, 
        ...
        -- Ward 5
        ('household_010', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 5, 
        ...
        ('household_011', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 5, 
        ...
        -- Ward 6
        ('household_012', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 6, 
        ...
        ('household_013', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 6, 
        ...
        -- Ward 7
        ('household_014', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 7, 
        ...
        ('household_015', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 7, 
        ...
        -- Ward 8
        ('household_016', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 8, 
        ...
        ('household_017', 'likhupike', 'lumbini', '58', 'लिखु पिके गाउँपालिका', 8, 
