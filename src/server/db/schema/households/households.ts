...
export const households = pgTable("acme_likhupike_households", {
...
export const stagingHouseholds = pgTable("staging_acme_likhupike_household", {
...
export const householdEditRequests = pgTable("acme_likhupike_household_edit_requests", {
