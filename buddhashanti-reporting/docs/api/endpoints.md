...
The likhupike Digital Profile Report API provides comprehensive access to municipality data, report generation, and administrative functions. The API follows RESTful principles and returns JSON responses.

## Base URL

```
Development: http://localhost:8000/api/v1/
Production: https://likhupike-report.gov.np/api/v1/
```
