"""
Custom User model for likhupike Report System

This model extends Django's AbstractUser to add custom fields
specific to the likhupikeMunicipality reporting system.
"""
...
class User(AbstractUser):
    """
    Custom User model with additional fields for likhupikeReport System
    """
