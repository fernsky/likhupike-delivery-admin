...
# Add project path
sys.path.append(
    "/Users/trilochan/Desktop/final-delivery/digital-profile/likhupike/likhupike-report"
)

# Setup Django
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "likhupike_report.settings.development")
django.setup()
